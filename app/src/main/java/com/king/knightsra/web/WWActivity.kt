...
import com.king.knightsra.constans.ConstansUsage.sub5
import com.king.knightsra.constans.ConstansUsage.sub6
import com.king.knightsra.constans.ConstansUsage.subOne
import com.king.knightsra.databinding.ActivityWebBinding
...
class WWActivity : AppCompatActivity() {
    ...
    lateinit var hrfghrdssxc: ActivityWebBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        hrfghrdssxc = ActivityWebBinding.inflate(layoutInflater)
